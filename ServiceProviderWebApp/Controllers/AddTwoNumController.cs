...
{
    /**
     * AddTwoNumController is a ASP.NET Web API controller class
     * It has a Get method
     */
    public class AddTwoNumController : ApiController
    {
        /**
         * This rest service adds two input integers and returns the output in JSON
         * 
        ...
        public int Get(int numOne, int numTwo, int token)
        {
            ...
            //if the datamodel is valid, it set result to the sum of numOne and numTwo 
            else
            {
