...
{
    /**
     * AddThreeNumController is a ASP.NET Web API controller class
     * It has a Get method
     */
    public class AddThreeNumController : ApiController
    {
        /**
         * This rest service adds three input integers and returns the output in JSON
         * 
        ...
        public int Get(int numOne, int numTwo, int numThree, int token)
        {
            ...
            //if the datamodel is valid, it set result to the sum of numOne, numTwo and numThree
            else
            {
                //add numOne, numTwo and numThree
